...
fn main() -> anyhow::Result<()> {
    ...
    let answer = match cli.command {
        ...
        Command::Store { remote, token_env } => gitlab::store_answer(&remote, token_env.as_deref()),
        Command::Files { remote, token_env } => gitlab::files_answer(&remote, token_env.as_deref()),
