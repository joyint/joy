...
- All item titles, descriptions, and comments must be in English, regardless of the conversation language.
- Before implementing a backlog item, comment the planned solution into the task. Confirm with the user, then implement.
